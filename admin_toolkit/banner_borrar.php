...
<?php
if ((isset($_POST['idbanner'])) && ($_POST['idbanner'] != "")) {
  $deleteSQL = sprintf("DELETE FROM dlg_banner WHERE idbanner=%s",
  ...
  $deleteSQL = sprintf("DELETE FROM dlg_banner WHERE idbanner=%s",
                       GetSQLValueString($_GET['idbanner'], "int"));
...
mysql_select_db($database_config, $config);
$query_registro = sprintf("SELECT idbanner, imagen FROM dlg_banner WHERE idbanner = %s", GetSQLValueString($colname_registro, "int"));
...
<div class="uno"><a class="fa fa-wrench"></a> BORRAR BANNER</div>
<div class="entero">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="4">
   <tr>
      <td colspan="4" align="center">Se borrará el banner <?php echo $row_registro['imagen']; ?>  <input name="idbanner" type="hidden" id="idbanner" value="<?php if(isset($_POST['idbanner'])){ echo $_POST['idbanner']; } else { echo $row_registro['idbanner'];}?>"></td>
      </tr>
      <tr>
