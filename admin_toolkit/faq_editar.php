...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "formguardar")) {
  $updateSQL = sprintf("UPDATE dlg_faq SET pregunta=%s, respuesta=%s WHERE idfaq=%s",
...
<div class="uno"><a class="fa fa-wrench"></a> EDITAR FAQ</div>
<div class="entero">
<form method="POST" action="<?php echo $editFormAction; ?>" name="formguardar" id="formguardar" onSubmit="MM_validateForm('faq','','R');return document.MM_returnValue">
  <table width="100%" border="0" cellspacing="0" cellpadding="4">
    <tr>
    <td><strong>Pregunta</strong></td>
    <td><textarea name="pregunta" cols="40" id="pregunta"><?php echo $row_registro['pregunta']; ?></textarea>      <input name="idfaq" type="hidden" id="idfaq" value="<?php echo $row_registro['idfaq']; ?>"></td>
    <td><strong>Respuesta</strong></td>
    <td><textarea name="respuesta" cols="40" id="respuesta"><?php echo $row_registro['respuesta']; ?></textarea></td>
    </tr>
      <tr>
        <td>&nbsp;</td>
