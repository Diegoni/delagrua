...
$colname_registros = "";
if (isset($_GET['marca'])) {
  $colname_registros = $_GET['marca'];
}
mysql_select_db($database_config, $config);
$query_registros = sprintf("SELECT idmarca, marca FROM dlg_marca WHERE marca LIKE %s ORDER BY marca ASC", GetSQLValueString("%" . $colname_registros . "%", "text"));
...
<div class="uno"><a class="fa fa-wrench"></a> MARCAS</div>
<div class="entero">
<table width="100%" border="0" cellspacing="0" cellpadding="4">
  <tr>
    <td colspan="2">
    <form action="marca.php" method="get" id="formbuscar" name="formbuscar">
    <strong>Marca
      <input name="marca" type="text" id="marca" value="<?php echo $_GET['marca'];?>" maxlength="100" onClick="this.value='';">
  ...
  <tr>
    ...
    <td><a href="marca_nuevo.php"><img src="img/iconos/nuevo.png" alt="Nuevo" width="32" height="32" title="Nuevo"/></a></td>
    </tr>
  <?php if ($totalRows_registros > 0) { // Show if recordset not empty ?>
    <?php do { ?>
      <tr>
        <td><?php echo $row_registros['marca']; ?></td>
        <td><a href="marca_editar.php?idmarca=<?php echo $row_registros['idmarca']; ?>"><img src="img/iconos/editar.png" alt="Editar" width="32" height="32" title="Editar"/></a>&nbsp;&nbsp;<a href="marca_borrar.php?idmarca=<?php echo $row_registros['idmarca']; ?>"><img src="img/iconos/borrar.png" width="32" height="32" alt=""/></a></td>
        </tr>
