...
if ((isset($_POST['idmarca'])) && ($_POST['idmarca'] != "")) {
  $deleteSQL = sprintf("DELETE FROM dlg_marca WHERE idmarca=%s",
...
<div class="uno"><a class="fa fa-wrench"></a> BORRAR MARCA</div>
<div class="entero">
<form method="POST" action="<?php echo $editFormAction; ?>" name="formguardar" id="formguardar">
  <table width="100%" border="0" cellspacing="0" cellpadding="4">
    <tr>
    <td colspan="4" align="center">Se borrará la marca <?php echo $row_registro['marca']; ?> <input name="idmarca" type="hidden" id="idmarca" value="<?php echo $row_registro['idmarca']; ?>"></td>
    </tr>
      <tr>
