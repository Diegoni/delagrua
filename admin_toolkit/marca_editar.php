...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "formguardar")) {
  $updateSQL = sprintf("UPDATE dlg_marca SET marca=%s WHERE idmarca=%s",
...
if (isset($_GET['idmarca'])) {
  $colname_registro = $_GET['idmarca'];
}
mysql_select_db($database_config, $config);
$query_registro = sprintf("SELECT * FROM dlg_marca WHERE idmarca = %s", GetSQLValueString($colname_registro, "int"));
...
<div class="uno"><a class="fa fa-wrench"></a> EDITAR MARCA</div>
<div class="entero">
<form method="POST" action="<?php echo $editFormAction; ?>" name="formguardar" id="formguardar" onSubmit="MM_validateForm('marca','','R');return document.MM_returnValue">
  <table width="100%" border="0" cellspacing="0" cellpadding="4">
    ...
    <td><input name="marca" type="text" id="marca" value="<?php echo $row_registro['marca']; ?>" maxlength="250">
      <input name="idmarca" type="hidden" id="idmarca" value="<?php echo $row_registro['idmarca']; ?>"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    </tr>
      <tr>
