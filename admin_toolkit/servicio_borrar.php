...
<div class="uno"><a class="fa fa-wrench"></a> BORRAR SERVICIO</div>
<div class="entero">
<form method="POST" action="<?php echo $editFormAction; ?>" name="formguardar" id="formguardar" onSubmit="MM_validateForm('servicio','','R');return document.MM_returnValue">
  <table width="100%" border="0" cellspacing="0" cellpadding="4">
    <tr>
    <td colspan="4" align="center">Se borrará la servicio <?php echo $row_registro['servicio']; ?> <input name="idservicio" type="hidden" id="idservicio" value="<?php echo $row_registro['idservicio']; ?>"></td>
    </tr>
      <tr>
