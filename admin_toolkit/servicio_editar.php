...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "formguardar")) {
  $updateSQL = sprintf("UPDATE dlg_servicio SET servicio=%s WHERE idservicio=%s",
...
if (isset($_GET['idservicio'])) {
  $colname_registro = $_GET['idservicio'];
}
mysql_select_db($database_config, $config);
$query_registro = sprintf("SELECT * FROM dlg_servicio WHERE idservicio = %s", GetSQLValueString($colname_registro, "int"));
...
<div class="uno"><a class="fa fa-wrench"></a> EDITAR SERVICIO</div>
<div class="entero">
<form method="POST" action="<?php echo $editFormAction; ?>" name="formguardar" id="formguardar" onSubmit="MM_validateForm('servicio','','R');return document.MM_returnValue">
  <table width="100%" border="0" cellspacing="0" cellpadding="4">
    <tr>
    <td><strong>Servicio</strong></td>
    <td><input name="servicio" type="text" id="servicio" value="<?php echo $row_registro['servicio']; ?>" maxlength="250">
      <input name="idservicio" type="hidden" id="idservicio" value="<?php echo $row_registro['idservicio']; ?>"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    </tr>
      <tr>
