...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formguardar")) {
  $colname_registro = $_POST['servicio'];
  mysql_select_db($database_config, $config);
  $query_registro = sprintf("SELECT * FROM dlg_servicio WHERE servicio = %s", GetSQLValueString($colname_registro, "text"));
  ...
  if($totalRows_registro == 0){
	  $insertSQL = sprintf("INSERT INTO dlg_servicio (servicio) VALUES (%s)",
	  ...
	  $servicioexistente = "El servicio no se agreg&oacute; porque ya existe un servicio con ese nombre la base de datos.";
  }
}
?>
<!DOCTYPE html>
...
<div class="uno"><a class="fa fa-wrench"></a> NUEVO SERVICIO</div>
<div class="entero">
<form method="POST" action="<?php echo $editFormAction; ?>" name="formguardar" id="formguardar" onSubmit="MM_validateForm('servicio','','R');return document.MM_returnValue">
  <table width="100%" border="0" cellspacing="0" cellpadding="4">
    ...
    <tr>
      <td><?php echo $servicioexistente;?></td>
    </tr>
    <?php } else { ?>
    <tr>
    <td><strong>Servicio</strong></td>
    <td><input name="servicio" type="text" id="servicio" maxlength="250"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    </tr>
      <tr>
