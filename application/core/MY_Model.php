...
---------------------------------------------------------------------------------*/ 	
    ...
    function getSearch($query, $tipovehiculo)
    {
        $query_registros = "
            SELECT 
                *,
            ...
            FROM (
                ...
                FROM 
                    dlg_taller t
                LEFT JOIN 
                    dlg_tallerservicio ts ON t.idtaller = ts.idtaller
                LEFT JOIN 
                    dlg_servicio s ON s.idservicio = ts.idservicio
                LEFT JOIN 
                    dlg_marca m ON t.idmarca = m.idmarca
                WHERE 
                    t.nombre = '" . $query . "'
                UNION SELECT 20 AS relevance,
                    t.idtaller,
                    t.nombre,
                    s.servicio,
                    t.locality,
                ...
                LEFT JOIN 
                    dlg_marca m ON t.idmarca = m.idmarca
                WHERE 
                    s.servicio like '%". $query ."%'
                UNION SELECT 10 AS relevance,
                    t.idtaller,
                    t.nombre,
                    s.servicio,
                    t.locality,
                ...
                LEFT JOIN 
                    dlg_marca m ON t.idmarca = m.idmarca
                WHERE 
                    t.locality like '%". $query ."%'
                UNION SELECT 7 AS relevance,
                    t.idtaller,
                    t.nombre,
                    s.servicio,
                    t.locality,
