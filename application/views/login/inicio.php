...
<link rel="stylesheet" href="<?php echo base_url().'librerias/';?>css/normalize.min.css">
<link rel="stylesheet" href="<?php echo base_url().'librerias/';?>css/main.css">
<link href="<?php echo base_url().'librerias/';?>css/grua.css" rel="stylesheet" type="text/css">
<link href="<?php echo base_url().'librerias/';?>fonts/fuentes.css" rel="stylesheet" type="text/css">
<link href="<?php echo base_url().'librerias/';?>font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
<script>
...
<script src="<?php echo base_url().'librerias/';?>js/vendor/modernizr-2.6.2-respond-1.1.0.min.js"></script></head>
<script src="<?php echo base_url().'librerias/';?>js/vendor/modernizr-2.6.2-respond-1.1.0.min.js"></script>
...
<script src="<?php echo base_url().'librerias/';?>js/main.js"></script>
...
<div class="cont-pop"><!--pop-->
     ...
     <div class="cen">
       <div class="box-pop">
		  ...
		  <!-- facebook login -->
          <a href="#"><img src="<?php echo base_url();?>/assets/img/facebook-connect.png" alt="Fb Connect" title="Login with facebook" onclick="FBLogin();"/></a></div>
		  <!-- fin facebook login -->
