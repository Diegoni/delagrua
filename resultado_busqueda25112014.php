...
<div class="cont"><!--cont-->
      ...
      <div class="nav-barra sombra"><!--barra-->
           <ul>
              ...
              <?php } else { ?>
              <li><a href="index.php#busca_taller">CALIFICA UN TALLER</a></li>
              <?php } ?>
...
?>
            ...
            <li class="boton-b"><a href="#" onClick="document.formbuscar2.submit();">BUSCAR</a></li>
            </form>
            </div>
</div><!--izq-->
...
?>
            ...
            <input name="ordenarpor" type="hidden" id="ordenarpor" value="<?php if(isset($_GET['ordenarpor'])) { echo $_GET['ordenarpor'];} else { echo "nombre"; }?>">
            <input name="orden" type="hidden" id="orden" value="<?php if(isset($_GET['orden'])) { echo $_GET['orden'];} else { echo "ASC"; }?>">
            <li class="boton-b"><a href="#" onClick="document.formbuscar.submit();">BUSCAR</a></li>
            </form>
            </div>
</div><!--izq-->
